...
const fetchUsersFromDb = async (): Promise<{ success: boolean; users: User[] }> => {
  try {
    ...
    const response = await fetch(`${import.meta.env.VITE_SERVER_ORIGIN}/api/users/admin/users`, {
      method: "POST",
...
const fetchUserVehicleRelationsFromDb = async (): Promise<UserVehicleData[]> => {
  try {
    ...
    const response = await fetch(`${import.meta.env.VITE_SERVER_ORIGIN}/api/comparison/getuservehiclecomparison`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        email: userEmail,
...
const ExpenseComparison = () => {
  ...
  const fetchComparisonData = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_SERVER_ORIGIN}/api/comparison/${endpoint}`, {
        method: "POST",
        headers: {
