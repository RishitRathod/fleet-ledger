...
const TableDemoPage = () => {
  ...
  const tableData: TableEntry[] = [
    { date: "2024-03-10", pricePerLiter: 100, amount: 500, liters: 5, kmStart: 12000, kmEnd: 12100, totalRun: 100, average: 20, avgCostPerKm: 5, days: 5, avgDailyRs: 100 },
    { date: "2024-03-15", pricePerLiter: 105, amount: 630, liters: 6, kmStart: 12100, kmEnd: 12220, totalRun: 120, average: 20, avgCostPerKm: 5.25, days: 6, avgDailyRs: 105 },
    { date: "2024-03-20", pricePerLiter: 102, amount: 510, liters: 5, kmStart: 12220, kmEnd: 12310, totalRun: 90, average: 18, avgCostPerKm: 5.67, days: 4, avgDailyRs: 127.5 },
    { date: "2024-03-25", pricePerLiter: 110, amount: 770, liters: 7, kmStart: 12310, kmEnd: 12450, totalRun: 140, average: 20, avgCostPerKm: 5.5, days: 7, avgDailyRs: 110 },
    { date: "2024-03-30", pricePerLiter: 108, amount: 540, liters: 5, kmStart: 12450, kmEnd: 12530, totalRun: 80, average: 16, avgCostPerKm: 6.75, days: 5, avgDailyRs: 108 },
    { date: "2024-04-05", pricePerLiter: 107, amount: 535, liters: 5, kmStart: 12530, kmEnd: 12630, totalRun: 100, average: 20, avgCostPerKm: 5.35, days: 5, avgDailyRs: 107 },
    { date: "2024-03-10", pricePerLiter: 100, amount: 500, liters: 5, kmStart: 12000, kmEnd: 12100, totalRun: 100, average: 20, avgCostPerKm: 5, days: 5, avgDailyRs: 100 },
    { date: "2024-03-15", pricePerLiter: 105, amount: 630, liters: 6, kmStart: 12100, kmEnd: 12220, totalRun: 120, average: 20, avgCostPerKm: 5.25, days: 6, avgDailyRs: 105 },
    { date: "2024-03-20", pricePerLiter: 102, amount: 510, liters: 5, kmStart: 12220, kmEnd: 12310, totalRun: 90, average: 18, avgCostPerKm: 5.67, days: 4, avgDailyRs: 127.5 },
    { date: "2024-03-25", pricePerLiter: 110, amount: 770, liters: 7, kmStart: 12310, kmEnd: 12450, totalRun: 140, average: 20, avgCostPerKm: 5.5, days: 7, avgDailyRs: 110 },
  ...
  const filteredData = sortData(tableData.filter((entry) => {
    return (
      ...
      entry.pricePerLiter.toString().includes(searchQuery) ||
      entry.amount.toString().includes(searchQuery) ||
      entry.liters.toString().includes(searchQuery) ||
      entry.kmStart.toString().includes(searchQuery) ||
      entry.kmEnd.toString().includes(searchQuery) ||
      entry.totalRun.toString().includes(searchQuery) ||
      entry.average.toString().includes(searchQuery) ||
      entry.avgCostPerKm.toString().includes(searchQuery) ||
      entry.days.toString().includes(searchQuery) ||
      entry.avgDailyRs.toString().includes(searchQuery)
    );
  }));
  ...
  const handlePDF = () => {
    const doc = new jsPDF();
    doc.autoTable({
      head: [['Date', 'Price/Liter', 'Amount', 'Liters', 'Km Start', 'Km End', 'Total Run', 'Average', 'Avg Cost/Km', 'Days', 'Avg Daily Rs']],
