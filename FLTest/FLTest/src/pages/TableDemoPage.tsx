              ...
              <div className="flex flex-wrap items-center justify-between gap-2 mb-4">
                ...
                <div className="flex items-center space-x-4">
                  <div className="flex items-center">
                    <label className="mr-2 text-sm text-gray-700 dark:text-neutral-200">
                      Rows per page:
                    </label>
                    <select
                  ...
                  <div className="relative inline-flex">
                    ...
                    {isDropdownOpen && (
                      <>
                        ...
                        />
                        <div
                          className="absolute right-0 top-full mt-1 w-32 bg-white rounded-xl shadow-xl dark:bg-neutral-900 z-50"
